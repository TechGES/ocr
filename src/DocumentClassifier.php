...
class DocumentClassifier
{
    ...
    {
        return "Analyse ce document et classe-le strictement en identity_card, residence_permit, passport, visa, crew_card, travel_document, other_identity_document, kbis, acte_propriete, msa ou autre.\n".
            ...
            "Si le document est un releve MSA ou un tableau de parcelles cadastrales MSA avec des colonnes comme DEPT, COM, PREFIXE, SECTION ou NUMERO PLAN, le type doit etre msa.\n".
            ...
            "Lis les titres visibles du document en meme temps que la MRZ. Un document avec MRZ d identite ou de voyage ne doit pas etre classe comme kbis, acte_propriete ou msa.\n".
